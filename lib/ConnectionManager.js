...
class ConnectionManager {
    ...
    _hasRoomInSocketServer(roomName){
     ...
     _startServer() {
        ...
        this.socketIoServer.on('connection', function (socket) {
            ...
            connectionsCounter++;
            //KalturaLogger.log("Number of connected clients [" + connectionsCounter + "] ");
    ...
    _onMessage(message) {
        ...
        try {
            ...
            messagesCounter++;
            //KalturaLogger.log("Number of messages received [" + messagesCounter + "] ");
    ...
    function getConnectionsCounter()
    {
...
module.exports.getConnectionsCounter = getConnectionsCounter;
module.exports.getMessagesCounter = getMessagesCounter;
